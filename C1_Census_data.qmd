...
comm_mode <- read_csv(
  ...
  col_types = cols(
    ...
    geography = col_character(),
    `geography code` = col_character(),
    `Method of travel to workplace: Total: All usual residents aged 16 years and over
    in employment the week before the census` = col_double(),
