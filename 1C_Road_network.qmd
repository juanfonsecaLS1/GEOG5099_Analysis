...
# Distance bands
dlim <- c (200, 500,1000,2000)

d <- dodgr_isoverts(graph_contr, from = nodes_list,dlim =  dlim)
```
...
filter(from=="858681448",dlim<=2000) |> 
  pull(id))
...
tm_shape(graph_sf |> 
  ...
  tm_dots("dlim",size = 0.1,breaks = c(0,200,500,1000,2000,2500))+
